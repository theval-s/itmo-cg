...
namespace val_cg {
    ...
    void MeshComponent::Initialize() {
        ...
        //Vertex Shader
        HRESULT res = D3DCompileFromFile(SPHERE_SHADER_PATH, nullptr, nullptr, "VSMain", "vs_5_0",
        ...
        res = D3DCompileFromFile(SPHERE_SHADER_PATH, nullptr /*Shader_Macros*/, nullptr, "PSMain", "ps_5_0",
    ...
    void val_cg::MeshComponent::Draw() {
    ...
    void val_cg::MeshComponent::Update(float deltaTime) {
